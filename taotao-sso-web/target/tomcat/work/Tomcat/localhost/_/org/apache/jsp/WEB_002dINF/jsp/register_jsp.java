 ...
 * Generated at: 2018-04-17 07:18:04 UTC
...
public final class register_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"item\" id=\"demail\">\r\n");
      out.write("\t\t\t\t\t\t<span class=\"label\"><b class=\"ftx04\">*</b>验证邮箱：</span>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<div class=\"fl item-ifo\">\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" id=\"email\" maxlength=\"11\" name=\"email\"\r\n");
      out.write("\t\t\t\t\t\t\t\tclass=\"text\" tabindex=\"4\"\r\n");
      out.write("\t\t\t\t\t\t\t\tautocomplete=\"off\" /> <i class=\"i-email\"></i> <label\r\n");
      out.write("\t\t\t\t\t\t\t\tid=\"email_succeed\" class=\"blank\"></label> <label\r\n");
      out.write("\t\t\t\t\t\t\t\tid=\"email_error\"></label>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t            \t\t\t//检查邮箱是否存在\r\n");
      out.write("\t\t\t\t            \t\t\t$.ajax({\r\n");
      out.write("\t\t\t\t            \t\t\t\turl : REGISTER.param.surl + \"/user/check/\"+$(\"#email\").val()+\"/3?r=\" + Math.random(),\r\n");
      out.write("\t\t\t\t            \t\t\t\tsuccess:function(data){\r\n");
      out.write("\t\t\t\t            \t\t\t\t\tif(data.data){\r\n");
      out.write("\t\t\t\t            \t\t\t\t\t\tREGISTER.doSubmit();\r\n");
      out.write("\t\t\t\t            \t\t\t\t\t}else{\r\n");
      out.write("\t\t\t\t            \t\t\t\t\t\talert(\"此邮箱已经被使用！\");\r\n");
